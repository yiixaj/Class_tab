...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Convertir las fechas y horas a un formato DateTime para mayor precisión
    $current_datetime = DateTime::createFromFormat('Y-m-d H:i', $current_date . ' ' . $current_time);
    $due_datetime_obj = DateTime::createFromFormat('Y-m-d H:i', $due_date . ' ' . $due_time);

    // Comparar las fechas
    if ($due_datetime_obj < $current_datetime) {
